...
Dingo S3™ is installed as an application running on your Pivotal Cloud Foundry&reg; in the `system` organization.
...
The secrets/UUIDs are generated by Ops Manager when the Dingo S3™ tile was first installed into Pivotal Cloud Foundry&reg;.
